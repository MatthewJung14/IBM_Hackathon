...
echo "Step 5: Person2 confirms receipt of allocated items."
curl -X POST http://localhost:5000/chat/message \
-H "Content-Type: application/json" \
-d '{
    "user_id": "person2",
...
# Step 6: Verify unfulfilled wanted items for Person2 (should be empty if fulfilled)
echo "Step 6: Checking unfulfilled wanted items for Person2."
...
# Step 7: Verify uncompleted donated items for Person1 (should show remaining units)
echo "Step 7: Checking uncompleted donated items for Person1."
...
# Step 8: Person3 requests more water than available (5 units) at location (29.6516, -82.5)
echo "Step 8: Person3 is initiating a request for 5 units of water at location (29.6516, -82.5)"
curl -X POST http://localhost:5000/chat/message \
-H "Content-Type: application/json" \
-d '{
    "user_id": "person3",
...
# Step 9: Person3 confirms the request
echo "Step 9: Person3 confirms the request for 5 units of water."
curl -X POST http://localhost:5000/chat/message \
-H "Content-Type: application/json" \
-d '{
    "user_id": "person3",
...
# Step 10: Person4 attempts to donate without specifying coordinates
echo "Step 10: Person4 is attempting to donate 2 units of water without specifying coordinates."
curl -X POST http://localhost:5000/chat/message \
-H "Content-Type: application/json" \
-d '{
    "user_id": "person4",
...
# Step 11: Person4 confirms the donation
echo "Step 11: Person4 confirms the donation of 2 units of water."
curl -X POST http://localhost:5000/chat/message \
-H "Content-Type: application/json" \
-d '{
    "user_id": "person4",
...
# Step 12: Person4 confirms allocation to wanted items if applicable ('confirm donate to')
echo "Step 12: Person4 confirms allocation of donation to wanted items (if applicable)."
curl -X POST http://localhost:5000/chat/message \
-H "Content-Type: application/json" \
-d '{
    "user_id": "person4",
